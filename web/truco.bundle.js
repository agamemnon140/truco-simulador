...
var Truco = (() => {
  ...
  var melhorada_1_default = {
    ...
    thrCall: 0.900622447047319,
    thrAccept: 0.6457046756729128,
    thrRaise: 2.0604641015786065,
    pBluff: -2.667379140018345,
    playTemp: -0.14549006695143893
  };
  ...
  var EvolvedBotPlayer = class {
    constructor(name, genome, rng = Math.random) {
      this.name = name;
      this.genome = genome;
      this.rng = rng;
    }
